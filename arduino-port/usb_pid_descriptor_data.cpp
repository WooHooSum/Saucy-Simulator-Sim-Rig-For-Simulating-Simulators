...
__ALIGN_BEGIN const uint8_t hid_1ffb_desc[kHid1FfbDescSize] __ALIGN_END =
{
...
//			0xC0     ,    //    End Collection
			...
			// Configuration and status are vendor feature reports with 63-byte payloads.
			0x06, 0x31, 0xFF, 0x09, 0x01, 0x85, 0x20,
			0x15, 0x00, 0x26, 0xFF, 0x00, 0x75, 0x08, 0x95, 0x3F, 0xB1, 0x02,
			0x09, 0x02, 0x85, 0x21,
			0x75, 0x08, 0x95, 0x3F, 0xB1, 0x02,

  0xC0    /*     END_COLLECTION	             */
};
static_assert(sizeof(hid_1ffb_desc) == kHid1FfbDescSize);
#endif
